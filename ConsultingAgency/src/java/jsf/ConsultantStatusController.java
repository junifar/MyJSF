...
import jpa.session.ConsultantStatusFacade;
...
public class ConsultantStatusController implements Serializable {
    ...
    @EJB private jpa.session.ConsultantStatusFacade ejbFacade;
    ...
    public ConsultantStatus getConsultantStatus(java.lang.Character id) {
