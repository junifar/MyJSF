...
/**
 * LogQueue generated by hbm2java
 */
@Entity
@Table(name="LOG_QUEUE"
    ,schema="dbo"
...
public class LogQueue  implements java.io.Serializable {
    ...
    public LogQueue(int id, Integer userId, String attentionTo, String message, Integer retries, Date lastRetries) {
       this.id = id;
       this.userId = userId;
       this.attentionTo = attentionTo;
       this.message = message;
       this.retries = retries;
       this.lastRetries = lastRetries;
    }
    ...
    public Date getLastRetries() {
        return this.lastRetries;
    }
    
    public void setLastRetries(Date lastRetries) {
        this.lastRetries = lastRetries;
    }
